...
# translation
SOURCES = autosectetool.py __init__.py autosecte.py autosectedialog.py ui_autosecte.py  

# global

PLUGINNAME = autosecte

PY_FILES = autosecte.py autosectedialog.py __init__.py autosectetool.py

UI_FILES = ui_autosecte.py
